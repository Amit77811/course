...
const team = {
    ...
    // tis will store an object with two properties -> {id:1,scores:[10,34,80]}
    ...
    addPlayers : function(id){
        ...
        console.log(`The player with ${id} is added`);
    },
    addScore: function(id,score){
        // find the player with id & push  this score to its score array
        for(let player of this.players){
            if(player.id === id){
                player.scores.push(score);
                console.log(`Score ${score} added to player ${id}`);
                return;
            }
        }
    ...
    //     // calculate average of scores of all players combined
    // let total = 0;     
    // let count = 0;      
